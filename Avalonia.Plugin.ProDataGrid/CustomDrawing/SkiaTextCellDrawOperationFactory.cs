...
namespace Avalonia.Plugin.ProDataGrid.CustomDrawing;
    ...
    IDataGridCellDrawOperationArrangeProvider
{
    ...
    private readonly struct MetricsCacheEntry(MetricsCacheKey key, SkiaTextLayoutMetrics metrics)
    {
        public MetricsCacheKey Key { get; } = key;
        public SkiaTextLayoutMetrics Metrics { get; } = metrics;
    }

    private readonly struct ItemMetricsCacheEntry(MetricsCacheKey key, SkiaTextLayoutMetrics metrics)
    {
        public MetricsCacheKey Key { get; } = key;
        public SkiaTextLayoutMetrics Metrics { get; } = metrics;
    }
    ...
    private readonly struct MetricsCacheKey : IEquatable<MetricsCacheKey>
    {
        ...
        public override bool Equals(object? obj) => obj is MetricsCacheKey other && Equals(other);
    ...
    private readonly struct TypefaceCacheKey : IEquatable<TypefaceCacheKey>
    {
        ...
        public override bool Equals(object? obj) => obj is TypefaceCacheKey other && Equals(other);
    ...
    float ascent)
{
    ...
    public float[] LineWidths { get; } = lineWidths;
    public float MaxLineWidth { get; } = maxLineWidth;
    public float LineHeight { get; } = lineHeight;
    public float TotalHeight { get; } = totalHeight;
    public float Ascent { get; } = ascent;
}
