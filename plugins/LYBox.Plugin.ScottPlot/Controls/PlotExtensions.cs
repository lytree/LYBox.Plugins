...
internal static class PlotExtensions
{
    ...
    public static SP.Interactivity.Key GetKey(Key avaKey)
    {
        return avaKey switch
        {
            Key.LeftAlt => SP.Interactivity.StandardKeys.Alt,
            Key.RightAlt => SP.Interactivity.StandardKeys.Alt,
            Key.LeftShift => SP.Interactivity.StandardKeys.Shift,
            Key.RightShift => SP.Interactivity.StandardKeys.Shift,
            Key.LeftCtrl => SP.Interactivity.StandardKeys.Control,
            Key.RightCtrl => SP.Interactivity.StandardKeys.Control,
            _ => new SP.Interactivity.Key(avaKey.ToString()),
        };
    }

    public static Cursor GetCursor(this SP.Cursor cursor)
    {
