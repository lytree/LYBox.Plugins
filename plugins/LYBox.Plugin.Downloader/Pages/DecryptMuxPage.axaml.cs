...
public partial class DecryptMuxPage : UserControl
{
    private DecryptMuxViewModel? _currentVm;

    public DecryptMuxPage()
    {
        InitializeComponent();
    ...
    private void OnDataContextChanged(object? sender, EventArgs e)
    {
        ...
        _currentVm = DataContext as DecryptMuxViewModel;
