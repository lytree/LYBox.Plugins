...
public partial class LiveRecordPage : UserControl
{
    private LiveRecordViewModel? _currentVm;

    public LiveRecordPage()
    {
        InitializeComponent();
    ...
    private void OnDataContextChanged(object? sender, EventArgs e)
    {
        ...
        _currentVm = DataContext as LiveRecordViewModel;
