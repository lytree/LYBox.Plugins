...
public sealed class DownloadCoordinator
{
    ...
    private readonly DouyinDownloadOrchestrator _orchestrator;
    private readonly DouyinSettingsStore _settings;

    public DownloadCoordinator(DownloadQueue queue, DouyinApiClient api, DouyinDownloadOrchestrator orchestrator, DouyinSettingsStore settings)
    {
        _queue = queue;
        _api = api;
